...
class MoviesView(Resource):
    ...
    @auth_required
    def get(self):
        """Получение БД по всем фильмам привелегия авторизованного юзера"""
    ...
    @admin_required
    def post(self):
        """Добавление в БД фильмов привелегия админа"""
...
class MovieView(Resource):
    ...
    @auth_required
    def get(self, bid):
        """Получение данных по фильму из БД по id привелегия авторизованного юзера"""
